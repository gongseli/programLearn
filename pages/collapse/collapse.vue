<template>
	<!-- <view v-for="(item, index) in dataList" :key="item.id" @click="menu_onclick" @appear="onappear"> -->
	<view>
		<uni-section title="java基础" type="line" ref="list">
			<uni-collapse  accordion v-model="accordionVal" @change="change">
				<uni-collapse-item  v-for="(item,index) in menuInfoList" :key="item.id" :title="item.name"
				thumb="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/460d46d0-4fcc-11eb-8ff1-d5dcf8779628.png">
					<view class="subcontent" v-for="(item2, index2) in item.detail" @click="menu_onclick">
